        ...
        (function () {
            "use strict";
            // ----- 6 LEVELS -----
            const levelOrder = [0, 1, 2, 3, 4, 5]; // 6 levels
            const levelConfig = [
                { rows: 3, cols: 4, pairs: 6, gridClass: 'grid-level-0', label: 'Level 1' },
                { rows: 4, cols: 4, pairs: 8, gridClass: 'grid-level-1', label: 'Level 2' },
                { rows: 4, cols: 5, pairs: 10, gridClass: 'grid-level-2', label: 'Level 3' },
                { rows: 4, cols: 6, pairs: 12, gridClass: 'grid-level-3', label: 'Level 4' },
                { rows: 5, cols: 6, pairs: 15, gridClass: 'grid-level-4', label: 'Level 5' },
                { rows: 6, cols: 6, pairs: 18, gridClass: 'grid-level-5', label: 'Level 6' }
            ];
            ...
            const iconSet = [
                ...
                'fa-wand-sparkles', 'fa-hat-wizard', 'fa-skull', 'fa-ghost', 'fa-tree', 'fa-leaf-maple',
                'fa-campground', 'fa-frog', 'fa-lion', 'fa-monkey', 'fa-paw', 'fa-rainbow', 'fa-feather-pointed'
            ];
            ...
            function levelComplete() {
                ...
                if (last) {
                    nextInfo.innerHTML = '🌟 Legendary! You\'ve dominated all 6 levels! 🌟<br>Claim your final trophy!';
                    nextBtn.innerHTML = '<i class="fas fa-crown mr-2"></i> Claim Victory';
                } else {
                    const nextLevel = levelConfig[currentLevelIndex + 1];
                    nextInfo.innerHTML = `🎉 Incredible! Next: <strong>${nextLevel.label}</strong> with <strong>${nextLevel.pairs} pairs</strong>! 🚀`;
            ...
            function goToNextLevel() {
                ...
                buildBoard();
                showToast(`✨ Moving to ${levelConfig[currentDifficulty].label}!`, 1800);
            }
